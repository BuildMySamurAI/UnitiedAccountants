...
import { uploadClientDocumentMulti } from "./actions";

export default function DocumentUploaderMulti({
  companyId,
  ghlFieldId,
  label,
  existing,
  ...
  async function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const result = await uploadClientDocumentMulti(companyId, ghlFieldId, formData);
